...
//function that includes LUT of multiplication results
unsigned int MultLUT (unsigned int value)
{
...
int main()
{
	...
	//MixColumns
	state[0] = tempstate0 ^ (MultLUT(tempstate1));
	state[1] = (MultLUT(tempstate0)) ^ tempstate1;
	state[2] = tempstate2 ^ (MultLUT(tempstate3));
	state[3] = (MultLUT(tempstate2)) ^ tempstate3;
